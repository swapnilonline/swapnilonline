      ...
      <article className="flex max-w-[68ch] flex-col gap-8 py-16 sm:py-20">
        <header className="flex flex-col gap-4">
          ...
          <p className="text-[19px] text-ink-soft">
            These apply to {site.program} and the Offer Design Intensive, sold by {site.name}.
          </p>
        </header>
        ...
        <Section title="The first-client guarantee">
          <p>
            ...
            have a paying client by day 90 of the Launch program, Swapnil keeps working with you at
            no extra cost until you do. This is written into the agreement you sign at enrolment.
          </p>
        </Section>

        <Section title="Refunds">
          <p>
            <b>Launch and Launch + Scale:</b> a full refund is available within 7 days of your first
          ...
          <p>
            <b>Offer Design Intensive:</b> refundable in full up to 24 hours before the session.
            The fee is credited toward the program if you join within 60 days.
          </p>
          <p>
            <b>Launch Call:</b> free. Please cancel or reschedule through the calendar link if you
        ...
        <Section title="An honest note on earnings">
          <p>
            No income is promised. What you earn depends on your skill, your market, and the work
            you put in. Reviews on this site are real and unedited, and they describe those
            people&rsquo;s experience, not a guarantee of yours.
          </p>
        </Section>
